...
//
//    private final MutableLiveData<List<FoodItem>> _foods      = new MutableLiveData<>();
...
//    private List<FoodItem> allFoods = Arrays.asList(
...
//    );
//
//    public LiveData<List<FoodItem>> getFoods()       { return _foods; }
//    public LiveData<Boolean>         isLoading()      { return _isLoading; }
//    public LiveData<String>          getErrorMsg()    { return _errorMsg; }
//    public LiveData<String>          getCartMessage() { return _cartMessage; }
//
//    /** Load tất cả hoặc theo category */
//    public void loadFoods(String categorySlug) {
//        _isLoading.setValue(true);
//        // TODO: thay bằng repository.getFoodsByCategory(categorySlug)
//        _foods.setValue(allFoods);
