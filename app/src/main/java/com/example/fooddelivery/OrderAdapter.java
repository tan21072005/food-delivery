...
import com.example.fooddelivery.Order;
...
public class OrderAdapter extends RecyclerView.Adapter<OrderAdapter.OrderViewHolder> {
    ...
    public OrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        int layoutRes;
        switch (viewType) {
            case TYPE_COMPLETED: layoutRes = R.layout.item_order_completed; break;
            case TYPE_CANCELLED: layoutRes = R.layout.item_order_cancelled; break;
            default:             layoutRes = R.layout.item_order_pending;   break;
        }
